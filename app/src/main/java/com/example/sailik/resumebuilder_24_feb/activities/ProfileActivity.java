...
import com.example.sailik.resumebuilder_24_feb.AppController;
import com.example.sailik.resumebuilder_24_feb.R;
import com.example.sailik.resumebuilder_24_feb.models.ResumeHeader;
...
public class ProfileActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestEmail()
                .build();
        mGoogleApiClient = ((AppController)getApplication()).getmGoogleApiClient();
